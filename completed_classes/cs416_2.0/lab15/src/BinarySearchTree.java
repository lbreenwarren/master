...
public class BinarySearchTree {
    ...
    private Data maxValue(Node n) {
        ...
        Data maxValueData = n.data;
        if (n.right != null && n.right.data.value > maxValueData.value) {
            maxValueData = n.data;
        }
        if (n.left != null && n.left.data.value > maxValueData.value) {
            maxValueData = n.data;
        }
        if (rightMax != null && rightMax.value > maxValueData.value) {
            maxValueData = rightMax;
        } 
        if (leftMax != null && leftMax.value > maxValueData.value) {
            maxValueData = leftMax;
        }
        return maxValueData;
